...
public class ActionManager {
    ...
    private Response mergeFiles(Action action) {
        ...
        if(fileType.equals("docx")){
            ...
            response = pdfHelper.mergePDFs(files,outputFolderPath);
            return response;
    ...
    private Response convertToWord(Action action) {
        ...
        if(fileType.equals("pdf")){
            ...
            response = pdfHelper.convertPDFsToWord(files,outputFolderPath);
            return response;
    ...
    private Response convertToText(Action action) {
        ...
        if(fileType.equals("docx")){
            ...
            response = wordHelper.wordToText(action,files);

        }else if(fileType.equals("pdf")){

            response = pdfHelper.convertPDFsToText(files,destinationPath);
    ...
    private Response addWatermark(Action action) {
        String watermarkImagePath = action.getActionParameter("WatermarkImage");
        String destinationPath = action.getOutputFolder();
        ensureDirectoryExists(destinationPath);
